    ...
    return (
        <div className="relative h-screen bg-[#004733]">
            ...
            <div className="flex flex-col h-full lg:flex-row lg:items-center">
                ...
                <div className="flex flex-col items-center md:items-start lg:pl-32 mt-16 lg:mt-32 lg:pr-40">
                    {/* Heading for mobile and medium screens */}
                    <h1 className="text-green-300 p-7 text-5xl text-center md:text-left lg:hidden font-bold">
                        Mortgages made simple
                    </h1>

                    <div className="flex flex-col mt-7 space-y-4 text-center md:text-left lg:text-left">
                        <a href="/start">  <button className="bg-green-400 px-24 py-5 text-black rounded-3xl md:px-14 lg:px-14 lg:w-full">
                            Start my approval
                        </button></a>
                        <p className="text-md text-white text-center md:text-left">3 min | No credit impact</p>
                    </div>
                </div>

                {/* Image Section */}
                <div className="relative bg-[#004733] lg:bg-transparent h-full flex items-center justify-center md:px-16 lg:pr-36 lg:mt-24 lg:m-20 ">
                    <div className="relative w-full flex flex-col md:w-3/4 lg:w-3/4 lg:h-auto lg:-mt-12">
                        ...
                        <img
                            ...
                            alt="Centered Image"
                            className="object-cover w-[90%] h-[95%] md:w-full md:h-auto lg:w-full lg:h-auto lg:mt-24"
                        />
                    </div>

                    {/* Rating Section */}
                    <div className="absolute bottom-0 left-0 right-0 flex justify-center pb-4 md:static md:right-16 md:bottom-16 md:w-1/2 md:pl-16 lg:static lg:right-16 lg:bottom-16 lg:w-1/3 lg:pl-16">
                        <div className="bg-green-950 text-center md:bg-[#004733] lg:bg-[#004733] md:w-2/3 lg:w-52 lg:mt-28">
